...
export default function TextContent({
  ...
  // True only after the user explicitly scrolled (wheel/touch/keyboard). Programmatic scrolls (TOC click, PDFâ†’middle sync) keep it false to prevent reverse-sync from drifting active section into a child while smooth-scroll is still in flight.
  ...
  useEffect(() => {
    ...
    // 'none' means this pane drove the change itself (user scrolled here), so don't reset the user-scroll flag â€” keep emitting as the user continues scrolling.
