...
class WorkspaceSectionNode(BaseModel):
    ...
    pdf_start_y: float | None = None
    pdf_end_y: float | None = None
...
class GuidelineFilterOptionsResponse(BaseModel):
    loai_van_bans: list[str] = Field(default_factory=list)
    don_vi_ban_hanhs: list[str] = Field(default_factory=list)
    chu_des: list[str] = Field(default_factory=list)
